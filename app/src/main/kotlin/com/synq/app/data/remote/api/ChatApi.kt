...
interface ChatApi {
    @GET("chats")
    suspend fun getChats(@Query("page") page: Int, @Query("limit") limit: Int): Response<List<ChatDto>>

    @GET("chats/{chatId}/messages")
    suspend fun getMessages(@Path("chatId") chatId: String, @Query("cursor") cursor: Long?, @Query("limit") limit: Int): Response<List<MessageDto>>

    @POST("chats/{chatId}/messages")
    suspend fun sendMessage(@Path("chatId") chatId: String, @Body request: SendMessageRequestDto): Response<MessageDto>
